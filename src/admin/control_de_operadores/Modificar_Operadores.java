 ...
 * @author Luis
 */
public class Modificar_Operadores extends javax.swing.JFrame {
    public Navegacion navegacion;
    int personal_id=-1;
    /**
     * Creates new form accseso
     */
    public Modificar_Operadores(Navegacion navegacion,Personal Datos) {
    ...
    setLocationRelativeTo(null); //se elije en que parte de la pantalla aparecera null (centro)
        ...
        try{
        BufferedImage imagen =ImageIO.read(Modificar_Operadores.class.getResourceAsStream("/imagenes/fondo.png"));;
        Control_fondo.
      ...
      jPanel1.setBorder(borde);}
        ...
        ContactoEmergencia Contacto=(new ContactoEmergenciaT()).Contacto(Datos.id);
        tnombrecontacto3.setText(Contacto.nombre);
        Temailcontacto3.setText(Contacto.correo);
        Ttelefonocontacto3.setText(Contacto.telefono+"");
        Tdirrecconcontacto3.setText(Contacto.direccion);
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Modificar de Operador ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        PersonalT Update=new PersonalT();
        ...
        Update.Update( personal, contacto);            
