...
public class Acceso extends javax.swing.JFrame {
    ...
    public Acceso() {
      ...
      setLocationRelativeTo(null); //se elije en que parte de la pantalla aparecera null (centro)
        ...
        this.setTitle("Ingreso-Inteppco");//titulo a la pantalla.
    ...
    private void initComponents() {
        ...
        jpContraseña.setBorder(javax.swing.BorderFactory.createEtchedBorder(null, new java.awt.Color(105, 183, 158)));
        ...
        jtUsuario.setBorder(javax.swing.BorderFactory.createEtchedBorder(null, new java.awt.Color(105, 183, 158)));
                ...
                .addGroup(panelReflect1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(panelReflect1Layout.createSequentialGroup()
                        ...
                        .addGroup(panelReflect1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jpContraseña, javax.swing.GroupLayout.PREFERRED_SIZE, 171, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnEntrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEntrarMouseClicked
        ...
        user= UsuarioT.Login(jtUsuario.getText(), Pass);
        if(user!=null){
//            JOptionPane.showMessageDialog(null, "Bienvenido :"+user.user,
//                "Inntepco", JOptionPane.PLAIN_MESSAGE);
            this.setVisible(false);
            if(user.rol==0 |user.rol==1){ 
               String mensajito="Bienvenido "+user.user+"<BR /> "+
                    " Estamos realizando la conexion a la maquinaria por favor espere un momento.";
               Mensaje msje= new Mensaje(mensajito);
               msje.setVisible(true); 
               Thread Leyendo= new Thread(){
                     public void run(){
                        Navegacion nav=new Navegacion(user);
                        nav.login();} 
                     }; 
             Leyendo.start();
            }else{ 
    ...
    private void errorsesion(){
        this.setVisible(true);
         Mensaje msje=new Mensaje("Favor de ingresar un usuario Valido "); 
                msje.setVisible(true);
    }
